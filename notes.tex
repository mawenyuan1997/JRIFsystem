...
\begin{itemize}
\item Implement function KAT$\rightarrow$SyKAT. So, we need to (i) find an algorithm that converts expressions on tests to Boolean BDDs and to (ii) find JAVA structures to implement BDDs (we used code from here: https://github.com/SigmaX/LightBDD/). We could look at the implementation of Pous for some help (PousSymKat directory):\\
