...
//
public class JrifTypeSystem_c extends JifTypeSystem_c {
//
...
//
//    @Override
    public RifConfPolicy rifreaderPolicy(Position pos, SymDFA dfa) {
        RifConfPolicy t = new RifReaderPolicy_c(dfa, this, pos);
        return t;
    }
//
//    @Override
