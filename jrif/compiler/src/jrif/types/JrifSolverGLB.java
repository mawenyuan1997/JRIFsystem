...
public class JrifSolverGLB extends JrifAbstractSolver {
	
	  /**
     * Constructor
     */
    public JrifSolverGLB(JrifTypeSystem ts, polyglot.frontend.Compiler compiler,
            String solverName) {
     ...
     * Constructor
     */
    protected JrifSolverGLB(JrifSolverGLB js) {
        super(js);
    }
    ...
    protected boolean search(Equation eqn) throws SemanticException {
        ...
        JrifSolverGLB js = new JrifSolverGLB(this);
