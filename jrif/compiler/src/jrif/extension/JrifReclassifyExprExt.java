...
public class JrifReclassifyExprExt extends JifExprExt implements Ext {
    private static final long serialVersionUID = SerialVersionUID.generate();

    public JrifReclassifyExprExt(ToJavaExt toJava) {
        super(toJava);
    }

    void inferLabelFrom(JrifLabelChecker lc, Position pos, JifContext A,
    ...
    @Override
    public Node labelCheck(LabelChecker lcin) throws SemanticException {
    	JrifLabelChecker lc = (JrifLabelChecker) lcin;
        ...
        A.setPc(Xe.N(), lc);
        lc = (JrifLabelChecker)lc.context(A);
